...
Example student complaint:

> "My hostel room has a water leakage problem."

System behavior:

1. AI detects it as a **Hostel issue**
2. Hostel agent asks:
   - Block number
   - Floor number
   - Room number
   - Urgency level
3. Student provides details.
4. System generates a structured complaint.
5. Complaint email is sent to hostel management.
6. Ticket is logged and assigned to staff.
...
- Automatic prioritization of urgent complaints
...
- Building scalable ticketing systems
- Integrating AI with traditional software workflows
