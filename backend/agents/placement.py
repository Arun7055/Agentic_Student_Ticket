...
class RealHostelEmailTool(BaseTool): 
    ...
    description: str = "Send real placement complaint email using SMTP" 
...
placement_followup_agent = Agent(
    role="Placement Issue Conversational Bot",
    goal="""
...
placement_structuring_agent = Agent(
    ...
    Urgency rules:
    - High → offer letter 
    - Medium →when will companies visit
    - Low → placement preparation materials
...
You are given a structured JSON with complaint details.
    ...
    [<URGENCY> URGENCY] Placement Issue ,
